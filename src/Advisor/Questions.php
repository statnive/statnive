	...
	private static function traffic_overview(): array {
		...
		return [
			...
			[
				'id'          => 'q10',
				'category_id' => $cat,
				'question'    => __( 'Has my traffic dropped sharply on the latest day?', 'statnive' ),
				'question_en' => 'Has my traffic dropped sharply on the latest day?',
				'keywords'    => [ 'drop', 'anomaly', 'dropped', 'sharply', 'sudden' ],
				'plan'        => self::PLAN_FREE,
				'surface'     => '/summary',
				'viz_hint'    => 'anomaly',
				'confidence'  => self::CONF_CALCULATED,
			...
			[
				'id'          => 'q11',
				'category_id' => $cat,
				'question'    => __( 'Has my traffic spiked sharply on the latest day?', 'statnive' ),
				'question_en' => 'Has my traffic spiked sharply on the latest day?',
				'keywords'    => [ 'spike', 'anomaly', 'jumped', 'sharply', 'sudden' ],
				'plan'        => self::PLAN_FREE,
				'surface'     => '/summary',
				'viz_hint'    => 'anomaly',
				'confidence'  => self::CONF_CALCULATED,
