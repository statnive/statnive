	...
	private static function traffic_overview(): array {
		...
		return [
			[
				'id'          => 'q1',
				'category_id' => $cat,
				'question'    => __( 'How many people visited my site today?', 'statnive' ),
				'question_en' => 'How many people visited my site today?',
				'keywords'    => [ 'traffic', 'visitors', 'today' ],
				'plan'        => self::PLAN_FREE,
				'surface'     => '/summary',
				'viz_hint'    => 'kpi_tile',
			...
			[
				'id'          => 'q2',
				'category_id' => $cat,
				'question'    => __( 'How many people visited this week?', 'statnive' ),
				'question_en' => 'How many people visited this week?',
				'keywords'    => [ 'traffic', 'visitors', 'this week', 'weekly' ],
				'plan'        => self::PLAN_FREE,
				'surface'     => '/summary',
				'viz_hint'    => 'kpi_tile',
				'confidence'  => self::CONF_DIRECT,
			...
			[
				'id'          => 'q5',
				'category_id' => $cat,
				'question'    => __( 'Is my traffic up or down compared with yesterday?', 'statnive' ),
				'question_en' => 'Is my traffic up or down compared with yesterday?',
				'keywords'    => [ 'traffic', 'compare', 'yesterday', 'delta' ],
				'plan'        => self::PLAN_FREE,
				'surface'     => '/summary',
				'viz_hint'    => 'delta',
			...
			[
				'id'          => 'q6',
				'category_id' => $cat,
				'question'    => __( 'Is my traffic up or down compared with last week?', 'statnive' ),
				'question_en' => 'Is my traffic up or down compared with last week?',
				'keywords'    => [ 'traffic', 'compare', 'last week', 'period' ],
				'plan'        => self::PLAN_FREE,
				'surface'     => '/summary',
				'viz_hint'    => 'delta',
				'confidence'  => self::CONF_CALCULATED,
	...
	private static function real_time_tracking_health(): array {
		...
		return [
			...
			[
				'id'          => 'q17',
				'category_id' => $cat,
				'question'    => __( 'Has Statnive received data today?', 'statnive' ),
				'question_en' => 'Has Statnive received data today?',
				'keywords'    => [ 'data', 'today', 'health' ],
				'plan'        => self::PLAN_FREE,
				'surface'     => '/summary',
				'viz_hint'    => 'status',
				'confidence'  => self::CONF_DIRECT,
