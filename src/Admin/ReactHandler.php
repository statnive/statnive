 ...
 * via wp_localize_script. Only loads on Statnive admin pages
...
final class ReactHandler {
	 ...
	 * page-scoping guard. See `CLAUDE.md` → "Admin Asset Scoping Rule".
	 *
	...
	/**
	 * Enqueue React SPA assets on Statnive admin pages only.
	 *
