...
final class QuestionsTest extends TestCase {
	...
	public function test_valid_ids_returns_117_ids(): void {
		$this->assertCount( 117, Questions::valid_ids() );
	}
