...
final class QuestionsTest extends TestCase {
	...
	public function test_valid_ids_returns_116_ids(): void {
		$this->assertCount( 116, Questions::valid_ids() );
	}
